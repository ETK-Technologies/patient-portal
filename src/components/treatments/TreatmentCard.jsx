...
export default function TreatmentCard({
  ...
  return (
    ...
    >
      <div className="absolute top-0 left-0 right-0 bottom-0 z-10 treatment-card w-full h-full"></div>
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 text-white z-20">
        ...
        {description && (
          <p className="font-normal text-sm md:text-[14px] leading-[140%] tracking-[0px] align-middle ">
            {description}
          </p>
        )}
      </div>
